...
const char *ssid = "sruthi"; //WIFI NAME OR HOTSPOT
const char *password = "kcharmila23"; //WIFI PASSWORD POR MOBILE HOTSPOT PASSWORD
...
void sendRfidLog(long cardid) {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    ...
    http.begin("http://192.168.0.5/RFIDandPHP/process.php");        
